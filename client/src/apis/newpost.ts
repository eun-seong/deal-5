...
export const apiNewPost = (args: { [key: string]: any }) => postFetchTemplate(newpostApiUrl(urls.upload), args); // 이미지 제외 컨텐츠 업로드 api
export const apiEditPost = (args: { [key: string]: any }) => postFetchTemplate(newpostApiUrl(urls.editPost), args); // 이미지 제외 컨텐츠 업로드 api
